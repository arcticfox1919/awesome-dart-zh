Awesome Dart 中文 [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
============

一个中文的 Dart 第三方框架、库收集。

### 贡献

目前这些可能只是部分收录，如果你有好的推荐，欢迎提交！

### 目录

* 库
  * [Web和客户端](#client-web-app-frameworks)
  * [服务端框架](#server-frameworks)
  * [游戏](#game-development)
  * [动画](#animation)
  * [模板](#template)
  * [代码生成](#code-gen)
  ...
  * [测试](#testing)
* [工具](#tools)
* [IDE、编辑器、插件](#ides-editors-and-plugins)
* [教程](#tutorials)
* [社区](#community)
* [其他](#everything-else)
...
<p id="client-web-app-frameworks"></p>  
...
<p id="ides-editors-and-plugins"></p>  
...
<p id="everything-else"></p>  

## 其他
* [Sentry](https://github.com/getsentry/sentry-dart) - Sentry提供自我托管和基于云的错误监控，帮助所有软件团队实时发现、分流和优先处理错误。
